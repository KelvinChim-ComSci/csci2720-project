    ...
    render() {
        return (
            <div>
                ...
                <form action="http://csci2720-g101.cse.cuhk.edu.hk/userData/createUser/create" method="post">
                    <div>
    ...
    render() {
        return (
            <div>
                ...
                <form action="http://csci2720-g101.cse.cuhk.edu.hk/userData/retrieveUser/retrieve" method="post">
                    <div>
                        <label htmlFor="user-id">User ID:</label>
                        <input type="text" id="user-id" name="id" required></input>
                    </div>
    ...
    render() {
        return (
            <div>
                ...
                <form action="http://csci2720-g101.cse.cuhk.edu.hk/userData/updateUser/update" method="post">
                    <div>
    ...
    render() {
        return (
            <div>
                ...
                <form action="http://csci2720-g101.cse.cuhk.edu.hk/userData/deleteUser/delete" method="post">
                    <div>
                        <label htmlFor="user-id">User ID:</label>
                        <input type="text" id="user-id" name="id" required></input>
                    </div>
